...
class MCPConfig(BaseModel):
    ...
    Attributes:
        ...
        host: The host IP address for the server.
...
class GraphitiEmbedderConfig(BaseModel):
    ...
    This class centralizes all embedding-related configuration parameters,
    such as the model name, API key, and maximum token limit.

    Attributes:
        model: The name of the embedding model to use.
        api_key: The API key for the embedding service.
        max_tokens: The maximum number of tokens for the embedding model.
    """
    ...
    def from_env(cls) -> "GraphitiEmbedderConfig":
        ...
        Returns:
            An instance of GraphitiEmbedderConfig populated from environment variables.
        """
    ...
    def from_cli_and_env(cls, args: argparse.Namespace) -> "GraphitiEmbedderConfig":
        ...
        Returns:
            An instance of GraphitiEmbedderConfig.
        """
        config = cls.from_env()
...
class GraphitiLLMConfig(BaseModel):
    ...
    This class centralizes all LLM-specific configuration parameters, including
    API keys, model selection, temperature, and token limits.

    Attributes:
        api_key: The API key for the language model service.
        model: The default language model to use.
        small_model: A smaller, secondary language model for less complex tasks.
        temperature: The sampling temperature for the language model.
        max_tokens: The maximum number of tokens for the language model.
    """
    ...
    def from_env(cls) -> "GraphitiLLMConfig":
        ...
        Returns:
            An instance of GraphitiLLMConfig populated from environment variables.
        """
    ...
    def from_cli_and_env(cls, args: argparse.Namespace) -> "GraphitiLLMConfig":
        ...
        Returns:
            An instance of GraphitiLLMConfig.
        """
        config = cls.from_env()
...
class Neo4jConfig(BaseModel):
    ...
    def from_env(cls) -> "Neo4jConfig":
        ...
        Returns:
            An instance of Neo4jConfig populated from environment variables.
        """
        return cls(
    ...
    def from_cli_and_env(cls, args: argparse.Namespace) -> "Neo4jConfig":
        """Create Neo4j configuration from CLI arguments, falling back to environment variables.

        Args:
            args: The parsed command-line arguments.

        Returns:
            An instance of Neo4jConfig.
        """
        config = cls.from_env()
...
class GraphitiConfig(BaseModel):
    ...
    a centralized point of access for application settings.

    Attributes:
        llm: Configuration for the language model client.
        embedder: Configuration for the embedder client.
        neo4j: Configuration for the Neo4j database connection.
        group_id: The default group ID for graph operations.
        use_custom_entities: A flag to enable or disable custom entity extraction.
        destroy_graph: A flag to determine whether to clear the graph on startup.
    """
    ...
    def from_env(cls) -> "GraphitiConfig":
        ...
        Returns:
            An instance of GraphitiConfig populated from environment variables.
        """
        return cls(
